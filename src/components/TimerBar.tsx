...
import { Play, Pause, Plus, SkipForward, Volume2, VolumeX, Eye, HelpCircle } from 'lucide-react';
...
export const TimerBar: React.FC<TimerBarProps> = ({
  ...
  const isUrgent = isQuestionMode ? timeLeft <= 15 : timeLeft <= 5;
      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center bg-slate-100 text-slate-700 px-3 py-1.5 rounded-lg font-medium text-sm border border-slate-200">
            <span className="text-slate-500 mr-1.5 font-normal">Question</span>
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            onClick={onAdvance}
            className={`flex items-center font-medium text-sm px-3.5 py-1.5 rounded-lg shadow-sm active:scale-95 transition-all ${
              isQuestionMode
