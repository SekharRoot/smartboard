    ...
    <div className="max-w-6xl mx-auto w-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-3 px-1">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs font-bold px-3 py-1 rounded-lg bg-slate-900 text-white border border-slate-900">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-200 pb-6 lg:pb-0 lg:pr-8">
            <div>
              ...
              <div className="flex items-center space-x-2.5 mb-4">
                <span className="w-9 h-9 rounded-xl bg-slate-900 text-white font-black text-base flex items-center justify-center shadow-xs">
                  {question.id}
                </span>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100">
                {!showHint ? (
                  <button
                    ...
                    className="inline-flex items-center text-xs font-bold text-slate-900 hover:text-black bg-slate-100 hover:bg-slate-200 border border-slate-300 px-3 py-1.5 rounded-lg transition-colors"
                  >
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center p-3.5 md:p-4 rounded-xl text-left border-2 transition-all duration-150 cursor-pointer ${
                        isSelected
                          ...
                          : 'border-slate-200 bg-white hover:border-slate-900 hover:bg-slate-50 text-slate-900'
                      }`}
                    >
                      <span
                      ...
                      <div className={`font-semibold text-base md:text-lg flex-1 ${isSelected ? 'text-white' : 'text-slate-900'}`}>
            ...
            <div className="mt-6 pt-5 border-t border-slate-100">
              <div className="mb-3 text-xs">
                {selectedOption ? (
                  <span className="text-slate-900 font-bold flex items-center bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-300">
              ...
              <button
                ...
                className="w-full flex items-center justify-center px-5 py-3 rounded-xl font-bold text-sm md:text-base bg-slate-900 hover:bg-black active:scale-[0.98] text-white shadow-sm transition-all cursor-pointer"
              >
