    ...
    <div className="max-w-6xl mx-auto w-full">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-5 md:p-8">
        ...
        >
          ...
          <div className="flex items-center space-x-2 bg-white/90 px-3 py-1.5 rounded-lg border border-slate-200 text-xs">
            <span className="text-slate-500 font-medium">Final Answer:</span>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            {question.formulaUsed && (
              <div className="bg-indigo-50/70 rounded-xl p-4 border border-indigo-200">
                ...
                <div className="text-indigo-950 font-bold text-base md:text-lg py-0.5">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between h-full space-y-4">
            <div>
              ...
              <div className="space-y-2.5">
                {question.solutionSteps.map((step, idx) => (
                  ...
                  >
                    <span className="flex-shrink-0 w-6 h-6 rounded-lg bg-emerald-100 text-emerald-800 font-black text-xs flex items-center justify-center mt-0.5">
                      {idx + 1}
                    </span>
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3">
              <div className="text-xs text-slate-500 font-medium">
                Auto-advancing in <span className="font-bold text-emerald-700 font-mono text-sm">{timeLeft}s</span>
              </div>

              <button
                id="btn-next-question"
                onClick={onProceedToNext}
                className="flex items-center px-6 py-2.5 rounded-xl font-bold text-sm bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white shadow-sm transition-all"
              >
